...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employee CL History</title>
...
<!-- #nav-menu-container -->
	...
	<h2 style="font-family:Georgia;color:#000000;" align="center"> Casual Leave  History</h2>
		<table align="center" id="example" class="table table-striped table-responsive table-bordered" border="2" cellspacing="0" style="table-layout: auto;width: 100%;">
			...
			<tbody>
			<?php 
			$sql = "SELECT sno,eid,leavetype,monthname,cldate,clcount,employees from adminaddclcount order by cldate desc";
			...
			{               ?>   
					<tr class="item">
					   ...
					   <td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->cldate);?></td>
						<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->clcount);?></td>
					</tr>
					  <?php $cnt=$cnt+1; } }?>
				</tbody>
			</table>
