...
$sql="INSERT INTO tblleaves(LeaveType,ToDate,FromDate,Description,Reason,Status,IsRead,empid) VALUES(:leavetype,:todate,:fromdate,:description,:Reason,:status,:isread,:epid)";
...
$lastInsertId = $dbh->lastInsertId();
    ...
    for ($i=0; $i<=9; $i++) 
    {
		...
		$sql1="INSERT INTO classadjustments (leaveid, empid, empname, adjustedfrom, department, Year, Section, Subject, Timings, classdate,adjempid) VALUES (:lastInsertId, :aempid, :aempname, :emname, :adept, :ayear, :asection, :asubject, :aclass, :adate,:epid)";
		...
		$atmt->bindParam(':epid',$epid,PDO::PARAM_STR);
        $atmt->execute();
