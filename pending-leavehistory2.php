			...
			<thead>
                                        <tr>
											...
											<th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">LEAVE DATE</th>
											 ...
											 <th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">REASON & CLASS ADJ</th>
...
{         
      ?>  
                                        ...
                                        <tr>
											...
											<td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;width:100px"><?php echo 'From<br>'.$result->FromDate.'<br>To<br>'.$result->ToDate;?></td>
											<td class="th-sm" style="font:small-caps 15px/30px Georgia, serif;">Reason:<?php echo htmlentities($result->Reason);?>Adj:<?php echo htmlentities($result->Description);?></td>
