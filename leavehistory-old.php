...
$_SESSION['cid']=$lid;
$sql = "SELECT t.Description as lea,ToDate,FromDate,l.Reason as des,PostingDate,AdminRemarkDate,AdminRemark,Status,l.id as lid from tblleaves l join tblleavetype t on l.LeaveType=t.LeaveType where l.empid=:eid order by lid desc";
...
if($stats==1){
                                             ?>
                                                ...
                                                <span style="color: red">Not Approved</span>
                                                 <?php } if($stats==0)  { ?>
 <span style="color: blue">waiting for approval</span><button><a href="cancelleave.php?leaveid=<?php echo $result->lid ?>">Cancel Leave</a></button>
 <?php } ?>
