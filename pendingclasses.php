...
<!-- #nav-menu-container -->
     ...
     <div class="container">
<h2 style="font-family:Georgia;color:#000000;" align="center">PENDING ADJUSTMENTS</h2>
			...
			<thead>
                                        <tr>
                                            ...
                                            <th class="th-sm" style="font: small-caps bold 14px/30px Georgia, serif;">Take Action</th>
                                        </tr>
                                    </thead>
...
$status=0;
$epid=$_SESSION['empid'];
$sql = "SELECT leaveid, empid, empname, adjustedfrom, department, Year, Section, Subject, Timings, classdate, actionstatus from classadjustments where empid=:epid and actionstatus=0";
...
<pre><a href="adjaction.php?leaveid=<?php echo htmlentities($result->leaveid);?>&empid=<?php echo htmlentities($result->empid);?>&status=1" class="waves-effect waves-light btn blue m-b-xs" id="approve<?php echo $cnt; ?>" >Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="adjaction.php?leaveid=<?php echo htmlentities($result->leaveid)?>&empid=<?php echo htmlentities($result->empid);?>&status=2" class="waves-effect waves-light btn blue m-b-xs" id="reject<?php echo $cnt; ?>">Reject</a></pre>
