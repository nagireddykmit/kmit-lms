...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>Employee LOP History</title>
...
<!-- #nav-menu-container -->
	...
	<h2 style="font-family:Georgia;color:#000000;" align="center"> LOP  History</h2>
		<table align="center" id="example" class="table table-striped table-responsive table-bordered" border="1" cellspacing="0" style="table-layout: auto;width: 100%;">
			...
			<tbody>
			<?php 
			$sql = "SELECT sno,emid,empname,monthname,lopdate,lop,remarks  from addlop order by lopdate desc";
			...
			{               ?>   
					<tr class="item">
						...
						<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->emid);?></td>
						...
						<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->lopdate);?></td>
						<td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->lop);?></td>
					   <td style="font: small-caps 15px/30px Georgia, serif;"><?php echo htmlentities($result->remarks);?></td>
					</tr>
					  <?php $cnt=$cnt+1; } }?>
				</tbody>
			</table>
